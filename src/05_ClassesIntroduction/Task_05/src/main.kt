...
fun main() {
    try {
        ...
        println("Enter the triangle apex coordinates on a plane " +
                "(must be two values separated by a space, comma or semicolon, each pair comes with a new line): ")
...
/* Sample I/O
=== Input 1 ===
Enter the triangle apex coordinates on a plane (must be two values separated by a space, comma or semicolon, each pair comes with a new line):
-4 4
-7 0
11 2
=== Output 1 ===
...
=== Input 4 ===
Enter the triangle apex coordinates on a plane (must be two values separated by a space, comma or semicolon, each from a new line):
a b
=== Output 4 ===
